package fr.bt.backend.service

import fr.bt.backend.config.ANONYMOUS_USER
import fr.bt.backend.config.DEFAULT_LANGUAGE
import fr.bt.backend.domain.Authority
import fr.bt.backend.domain.User
import fr.bt.backend.repository.AuthorityRepository
import fr.bt.backend.repository.UserRepository
import fr.bt.backend.security.USER
import fr.bt.backend.security.getCurrentUserLogin
import fr.bt.backend.service.dto.UserDTO
import fr.bt.backend.service.util.generateActivationKey
import fr.bt.backend.service.util.generatePassword
import fr.bt.backend.service.util.generateResetKey
import fr.bt.backend.web.rest.errors.EmailAlreadyUsedException
import fr.bt.backend.web.rest.errors.InvalidPasswordException
import fr.bt.backend.web.rest.errors.LoginAlreadyUsedException
