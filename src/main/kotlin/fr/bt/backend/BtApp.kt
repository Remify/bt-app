...
import fr.bt.backend.config.ApplicationProperties
...
class BtApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(BtApp::class.java)
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<BtApp>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(BtApp::class.java)
