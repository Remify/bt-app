...
import fr.bt.backend.security.ADMIN
import fr.bt.backend.security.USER
import fr.bt.backend.service.MailService
import fr.bt.backend.service.UserService
import fr.bt.backend.service.dto.PasswordChangeDTO
import fr.bt.backend.service.dto.UserDTO
import fr.bt.backend.web.rest.errors.ExceptionTranslator
import fr.bt.backend.web.rest.vm.KeyAndPasswordVM
import fr.bt.backend.web.rest.vm.ManagedUserVM
 ...
 */
@SpringBootTest(classes = [BtApp::class])
